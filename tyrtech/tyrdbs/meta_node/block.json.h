...
struct slice_builder final : public tyrtech::message::struct_builder<2, 4>
{
    ...
    {
        set_offset<0>();
        struct_builder<2, 4>::add_value(value);
    }
...
struct slice_parser final : public tyrtech::message::struct_parser<2, 4>
{
